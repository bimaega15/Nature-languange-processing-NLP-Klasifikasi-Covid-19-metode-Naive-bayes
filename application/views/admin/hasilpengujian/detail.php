    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mt-2">
                    <div class="card-header">
                        <i class="fas fa-table"></i> Hasil HasilPengujian
                    </div>
                    <div class="card-body">
                        <div class="table-responsive mt-3">
...
<script>
    $(document).ready(function() {
        var table = $('#dataTableLatih').DataTable({
            "ajax": "<?= base_url('Admin/HasilPengujian/loadDataLatih') ?>",
        });

        var table = $('#dataTableUji').DataTable({
            "ajax": "<?= base_url('Admin/HasilPengujian/loadDataUji') ?>",
        });

        var table = $('#dataTableHasil').DataTable({
            "ajax": "<?= base_url('Admin/HasilPengujian/loadDataHasil') ?>",
        });
    })
</script>