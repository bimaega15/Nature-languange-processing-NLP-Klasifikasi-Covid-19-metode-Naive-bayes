...
<div class="card mt-2">
    <div class="card-header">
        <i class="fas fa-table"></i> Submit hasil
    </div>
    <div class="card-body">
        <form action="<?= base_url('Admin/Metode/submit') ?>" method="post">
            <button class="btn btn-primary form-control" onclick="return confirm('Yakin ingin submit hasil ini ? ')">
